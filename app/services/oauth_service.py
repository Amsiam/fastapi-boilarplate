...
from app.repositories.auth_repository import OAuthProviderRepository, OAuthAccountRepository
from app.repositories.user_repository import UserRepository, CustomerRepository
